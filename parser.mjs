...
function peg$parse(input, options) {
  ...
  const peg$c9 = "p";
  const peg$c10 = "bajo";
  const peg$c11 = "teclado";
  const peg$c12 = "bombo";
  const peg$c13 = "guiro";
  const peg$c14 = "contras";
  const peg$c15 = "contratiempos";
  const peg$c16 = "contratiempo";
  const peg$c17 = "congas";
  const peg$c18 = "jamblock";
  const peg$c19 = "jam";
  const peg$c20 = "(";
  const peg$c21 = ",";
  const peg$c22 = ")";
  const peg$c23 = "sonido";
  const peg$c24 = "s";
  const peg$c25 = "id";
  const peg$c26 = "\"";
  const peg$c27 = "octava";
  const peg$c28 = "o";
  const peg$c29 = "marcha";
  const peg$c30 = "tumbao";
  const peg$c31 = "acompa\xF1amiento";
  const peg$c32 = "acompanamiento";
  const peg$c33 = "ritmo";
  const peg$c34 = "punteo";
  const peg$c35 = "[";
  const peg$c36 = "|";
  const peg$c37 = "]";
  const peg$c38 = ":";
  const peg$c39 = "M7";
  const peg$c40 = "M";
  const peg$c41 = "mayor7";
  const peg$c42 = "mayor";
  const peg$c43 = "maj7";
  const peg$c44 = "maj";
  const peg$c45 = "min7";
  const peg$c46 = "min";
  const peg$c47 = "menor7b5";
  const peg$c48 = "menor7";
  const peg$c49 = "menor";
  const peg$c50 = "m7b5";
  const peg$c51 = "m7";
  const peg$c52 = "m";
  ...
  const peg$c69 = "_";
  const peg$c70 = "a";
  const peg$c71 = "\u{1D15D}";
  const peg$c72 = "\u{1D15E}";
  const peg$c73 = "\u{1D15F}";
  const peg$c74 = "\u{1D160}";
  const peg$c75 = "\u{1D161}";
  const peg$c76 = "\u{1D13B}";
  const peg$c77 = "\u{1D13C}";
  const peg$c78 = "\u{1D13D}";
  const peg$c79 = "\u{1D13E}";
  const peg$c80 = "\u{1D13F}";
  const peg$c81 = ".";
  const peg$c82 = "//";
  const peg$c83 = "/*";
  const peg$c84 = "*/";
  ...
  const peg$e10 = peg$literalExpectation("bajo", false);
  const peg$e11 = peg$literalExpectation("teclado", false);
  const peg$e12 = peg$literalExpectation("bombo", false);
  const peg$e13 = peg$literalExpectation("guiro", false);
  const peg$e14 = peg$literalExpectation("contras", false);
  const peg$e15 = peg$literalExpectation("contratiempos", false);
  const peg$e16 = peg$literalExpectation("contratiempo", false);
  const peg$e17 = peg$literalExpectation("congas", false);
  const peg$e18 = peg$literalExpectation("jamblock", false);
  const peg$e19 = peg$literalExpectation("jam", false);
  const peg$e20 = peg$literalExpectation("(", false);
  const peg$e21 = peg$literalExpectation(",", false);
  const peg$e22 = peg$literalExpectation(")", false);
  const peg$e23 = peg$literalExpectation("sonido", false);
  const peg$e24 = peg$literalExpectation("s", false);
  const peg$e25 = peg$literalExpectation("id", false);
  const peg$e26 = peg$literalExpectation("\"", false);
  const peg$e27 = peg$literalExpectation("octava", false);
  const peg$e28 = peg$literalExpectation("o", false);
  const peg$e29 = peg$literalExpectation("marcha", false);
  const peg$e30 = peg$literalExpectation("tumbao", false);
  const peg$e31 = peg$literalExpectation("acompa\xF1amiento", false);
  const peg$e32 = peg$literalExpectation("acompanamiento", false);
  const peg$e33 = peg$literalExpectation("ritmo", false);
  const peg$e34 = peg$literalExpectation("punteo", false);
  ...
  const peg$e39 = peg$literalExpectation("M7", false);
  const peg$e40 = peg$literalExpectation("M", false);
  const peg$e41 = peg$literalExpectation("mayor7", false);
  const peg$e42 = peg$literalExpectation("mayor", false);
  const peg$e43 = peg$literalExpectation("maj7", false);
  const peg$e44 = peg$literalExpectation("maj", false);
  const peg$e45 = peg$literalExpectation("min7", false);
  const peg$e46 = peg$literalExpectation("min", false);
  const peg$e47 = peg$literalExpectation("menor7b5", false);
  const peg$e48 = peg$literalExpectation("menor7", false);
  const peg$e49 = peg$literalExpectation("menor", false);
  const peg$e50 = peg$literalExpectation("m7b5", false);
  const peg$e51 = peg$literalExpectation("m7", false);
  const peg$e52 = peg$literalExpectation("m", false);
  const peg$e53 = peg$literalExpectation("dim", false);
  const peg$e54 = peg$literalExpectation("aug", false);
  const peg$e55 = peg$literalExpectation("sus2", false);
  const peg$e56 = peg$literalExpectation("sus4", false);
  const peg$e57 = peg$literalExpectation("7", false);
  const peg$e58 = peg$literalExpectation("#", false);
  const peg$e59 = peg$literalExpectation("bb", false);
  const peg$e60 = peg$classExpectation(["b", "x"], false, false, false);
  const peg$e61 = peg$classExpectation(["A", ",", " ", "B", ",", " ", "C", ",", " ", "D", ",", " ", "E", ",", " ", "F", ",", " ", "G"], false, false, false);
  const peg$e62 = peg$literalExpectation("do", false);
  const peg$e63 = peg$literalExpectation("re", false);
  const peg$e64 = peg$literalExpectation("mi", false);
  const peg$e65 = peg$literalExpectation("fa", false);
  const peg$e66 = peg$literalExpectation("sol", false);
  const peg$e67 = peg$literalExpectation("la", false);
  const peg$e68 = peg$literalExpectation("si", false);
  const peg$e69 = peg$literalExpectation("/", false);
  const peg$e70 = peg$literalExpectation("^", false);
  const peg$e71 = peg$literalExpectation("_", false);
  const peg$e72 = peg$literalExpectation("a", false);
  const peg$e73 = peg$literalExpectation("\u{1D15D}", false);
  const peg$e74 = peg$literalExpectation("\u{1D15E}", false);
  const peg$e75 = peg$literalExpectation("\u{1D15F}", false);
  const peg$e76 = peg$literalExpectation("\u{1D160}", false);
  const peg$e77 = peg$literalExpectation("\u{1D161}", false);
  const peg$e78 = peg$literalExpectation("\u{1D13B}", false);
  const peg$e79 = peg$literalExpectation("\u{1D13C}", false);
  const peg$e80 = peg$literalExpectation("\u{1D13D}", false);
  const peg$e81 = peg$literalExpectation("\u{1D13E}", false);
  const peg$e82 = peg$literalExpectation("\u{1D13F}", false);
  const peg$e83 = peg$literalExpectation(".", false);
  const peg$e84 = peg$classExpectation([["0", "9"]], false, false, false);
  const peg$e85 = peg$classExpectation([["a", "z"]], false, false, false);
  const peg$e86 = peg$literalExpectation("//", false);
  const peg$e87 = peg$classExpectation(["\r", "\n"], false, false, false);
  const peg$e88 = peg$anyExpectation();
  const peg$e89 = peg$literalExpectation("/*", false);
  const peg$e90 = peg$literalExpectation("*/", false);
  const peg$e91 = peg$classExpectation([" ", "\t", "\r", "\n"], false, false, false);
  ...
  function peg$f16(k, v) {return createProperty("sonido", v)  }
  function peg$f17(k, v) {return createProperty("id", v)  }
  function peg$f18(k, v) {
    if (v >= 0 && v <= 1) {
  ...
  function peg$f20(k, v) {return createProperty("octavaAbsoluta", v)  }
  function peg$f21(k, v) {
    if (v.length == 0) {
  ...
  function peg$f30() {return 'maj7'  }
  function peg$f31() {return 'maj'  }
  function peg$f32() {return 'm7b5'  }
  function peg$f33() {return 'min7'  }
  function peg$f34() {return 'min'  }
  function peg$f35() {return 'C'  }
  function peg$f36() {return 'D'  }
  function peg$f37() {return 'E'  }
  function peg$f38() {return 'F'  }
  function peg$f39() {return 'G'  }
  function peg$f40() {return 'A'  }
  function peg$f41() {return 'B'  }
  function peg$f42(s) {
    let g = createProperty("note", null);
    return Object.assign(s, g)
  }
  function peg$f43(r, o) {
  ...
  function peg$f46(f, g) {
    return Object.assign({}, f, g);
  }
  function peg$f47(f, g) {
    return Object.assign({}, f, g);
  }
  function peg$f48() {return createProperty("octavaRelativa", 1)  }
  function peg$f49() {return createProperty("octavaRelativa", (-1))  }
  function peg$f50(n) {return createProperty("note", n);  }
  function peg$f51() {return createProperty("note", "C4")  }
  function peg$f52() {return createProperty("note", "D4")  }
  function peg$f53() {return createProperty("note", "E4")  }
  function peg$f54() {return createProperty("note", "F4")  }
  function peg$f55() {return createProperty("note", "G4")  }
  function peg$f56() {return createProperty("duration", '1n');  }
  function peg$f57() {return createProperty("duration", '2n');  }
  function peg$f58() {return createProperty("duration", '4n');  }
  function peg$f59() {return createProperty("duration", '8n');  }
  function peg$f60() {return createProperty("duration", '16n');  }
  ...
  function peg$f69(letra, alteracion, cualidad) {
  ...
  function peg$f72() {    return parseFloat(text());  }
  ...
  function peg$parselistaDeAcordesGlobales() {
    ...
    if (s2 !== peg$FAILED) {
      s3 = peg$parse_();
      s4 = [];
      s5 = peg$parselistaDeAcordeGlobal();
      while (s5 !== peg$FAILED) {
        s4.push(s5);
        s5 = peg$currPos;
        s6 = peg$currPos;
        ...
        if (s6 !== peg$FAILED) {
          s6 = peg$parselistaDeAcordeGlobal();
          s5 = s6;
        } else {
          s5 = s6;
        }
